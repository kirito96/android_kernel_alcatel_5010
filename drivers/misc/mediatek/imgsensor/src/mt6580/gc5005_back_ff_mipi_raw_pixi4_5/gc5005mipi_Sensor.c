...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC5005MIPI_BACKFF_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static void gc5005_gcore_update_awb(void)
{
	...
	kal_uint16 rg_typical=0xa2,bg_typical=0xa7;	 
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_CHECK_SENSOR_ID:
        	  printk("duanjinhui -> backff SENSOR_FEATURE_CHECK_SENSOR_ID\n");
...
UINT32 GC5005_BACKFF_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
