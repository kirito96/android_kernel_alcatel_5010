...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_backporch				= 50; //modify by xin_liu for frame rate set to 60. 
	params->dsi.horizontal_frontporch				= 50; //modify by xin_liu for frame rate set to 60. 
